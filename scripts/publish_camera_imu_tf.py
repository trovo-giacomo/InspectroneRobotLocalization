        ...
        try:
            ...
            for params in rs_camera_intr_extr_params:
                for i in range(0,num_cameras):
                    ...
                    print("%g"%T_cam_imu[0][3])
                    print("%g"%T_cam_imu[1][3])
                    print("%g"%T_cam_imu[2][3])
                    ...
                    quat_cam_imu = quaternion_from_matrix(T_cam_imu)
                    # translation vector
                    tran_cam_imu = translation_from_matrix(T_cam_imu)

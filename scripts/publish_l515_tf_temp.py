...
if __name__ == '__main__':
    ...
    T_imu_camPose = concatenate_matrices(T_imu_camPose, offset)
    ...
    if(is_pub_tf):
        ...
        #---- T imu -> camera_frame ----#
        T_static_imu_camera = buildStaticTransform(T_imu_camPose, base_frame, camera_prefix + "_link") # connect Kalibr trnasformation with TF tree L515

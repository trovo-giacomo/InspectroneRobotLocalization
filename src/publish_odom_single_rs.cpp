...
int transformPose(geometry_msgs::PoseWithCovariance p_camOdo_pose, geometry_msgs::PoseWithCovariance& p_odom_bl){
    ...
    // if(abs(prevPose.pose.orientation.x - p_odom_bl.pose.orientation.x) > jump_threshold || abs(prevPose.pose.orientation.y - p_odom_bl.pose.orientation.y) > jump_threshold && abs(prevPose.pose.orientation.z - p_odom_bl.pose.orientation.z) > jump_threshold && abs(prevPose.pose.orientation.w - p_odom_bl.pose.orientation.w) > jump_threshold){
